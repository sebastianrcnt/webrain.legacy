...
jsPsych.plugins["reconstruction"] = (function () {
  ...
  plugin.trial = function (display_element, trial) {
    ...
    var after_response = function (info) {
      ...
      var key_i =
        typeof trial.key_increase == "string"
          ? jsPsych.pluginAPI.convertKeyCharacterToKeyCode(trial.key_increase)
          : trial.key_increase
      var key_d =
        typeof trial.key_decrease == "string"
          ? jsPsych.pluginAPI.convertKeyCharacterToKeyCode(trial.key_decrease)
          : trial.key_decrease
