...
// list 마우스 오버
$(".list-content-thumbnail > li").mouseover(function() {
    const href = $(this).children('a').attr('href');
    $(this).children('.pageOption').children('a').attr('href', href);
    $(this).children('a').children('.list-content-thumbnail-title').children('span').addClass('list-over')

}).mouseleave(function() {
    $(this).children('a').children('.list-content-thumbnail-title').children('span').removeClass('list-over')
});


// completed 에 이미지 넣기
const img = "<img class='completed-img' src='../images/completed.png' alt='완료'/>"
