...
$(".list-content-thumbnail > li").hover(
    function() {
        const imgWidth = $(this).children('.list-link').children('.image-container').children('img').width();
        const imgHeight = $(this).children('.list-link').children('.image-container').children('img').height();
        const txt = $(this).children('.list-link').children('.image-container')
            .siblings(".list-content-thumbnail-title")
            .children(".item-title")
            .text();

        $(this).children(".image-cover")
            .css({
                width: imgWidth,
                height: imgHeight,
                display: "flex",
            ...
            .show()
            .offset($(this).children('.list-link').children('.image-container').offset())
